...
export default function Signup(){
  ...
  const [invalidVisible,setInvalidVisible] = useState("hidden");
  ...
  const handleSignup = async()=>{
    ...
    if(!credentials.email.match(`^(?:(?!.*?[.]{2})[a-zA-Z0-9](?:[a-zA-Z0-9.+!%-]{1,64}|)|\"[a-zA-Z0-9.+!% -]{1,64}\")@[a-zA-Z0-9][a-zA-Z0-9.-]+(.[a-z]{2,}|.[0-9]{1,})$`)){
      setInvalidVisible("visible");
      setTimeout(()=>{
        setInvalidVisible("hidden");
      },3000);
    ...
    if(credentials.password.length<6 || credentials.password.match(`(?=.*\d.*)(?=.*[a-zA-Z].*)(?=.*[!#\$%&\?].*).{6,}`)){
      setInvalidVisible("visible");
      setTimeout(()=>{
        setInvalidVisible("hidden");
      },3000);
    ...
    return (
        <>
            <section className="h-screen" style={{zIndex: -1,maxWidth: "60%",marginLeft: "auto",marginRight: "auto" ,paddingTop: "50px"}}>
                ...
                <div className="mb-6 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                  <form>
                    ...
                    <div className="relative mb-2" data-te-input-wrapper-init>
                        <input value={credentials.firstName} onChange={handleChange}
                          type="text"
                        ...
                        <label
                          ...
                          className="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out -translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
                          >First Name
                        </label>
                      </div>

                      <div className="relative mb-2" data-te-input-wrapper-init>
                        <input value={credentials.lastName} onChange={handleChange}
                          type="text"
                          className="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                    ...
                    {/* <!-- Email input --> */}
                    <div className="relative mb-2" data-te-input-wrapper-init>
                      <input onChange={handleChange} value={credentials.email}
                        type="text"
                        className="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                    ...
                    <div className="relative mb-4" data-te-input-wrapper-init>
                      <input name="confirmPassword" value={credentials.confirmPassword} onChange={handleChange}
                        type="password"
                        className="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                    ...
                    <div style={{visibility: invalidVisible}}
                        className="mb-2 inline-flex w-full items-center rounded-lg bg-danger-100 px-6 py-2 text-base text-danger-700"
                        role="alert">
                        <span className="mr-2">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
